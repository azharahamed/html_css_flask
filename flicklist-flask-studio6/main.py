...
class Movie(db.Model):
    ...
    rating = db.Column(db.Enum(ratingsType))
    
    # TODO: add a ratings column to the Movie table - done
...
def movie_ratings():
    return render_template('ratings.html', movies = get_watched_movies(), ratingsType = ratingsType)
